...
description: DNS Stands for Domain Name Service. In a nutshell, what it does is translate hosts/computer's name into it's IP...
origin: https://github.com/SAFETAG/SAFETAG
origin_path: master/en/exercises/dns_enumeration/variant_zonetransfer.md
authors: SAFETAG
org_size_under: 1000
remote_options: Complete
skills_required: DNS, OSINT
...
:[](variant_using_online_tools_resources.md)

###### Active: DNSrecon

:[](variant_dns_recon.md)
...
:[](variant_dns_zonetransfer.md)

###### Active: MX Records

:[](variant_mx_records.md)
